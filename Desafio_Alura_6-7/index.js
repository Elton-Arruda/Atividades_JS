var categorias = ["Bebidas", "Temperos", "Laticinios", "Farinaceos", "Doces", "Salgados", "Açougue", "Limpeza", "Padaria", "Enlatados", "Molhos", "Cereais", "Frios", "Congelados", "Alimentos"]
var lista = []
var produto = ""
var quantidade = ""
var categoria = ""
...
function excluirElementoTela(){
  ...
  htmlCode += "</select>"
  htmlCode += "<button class='deleteButton' onclick='excluirElemento()' >Excluir item</button>"
  htmlCode += "<button class='normalButton' onclick='telaInicial()' >Voltar</button>"
...
function telaInicial(){
  ...
  var htmlCode = ""
    ...
    htmlCode += "<p>Primeiro adicione os produtos na lista, depois que adicionar todos os produtos clique em finalizar</p>"
    ...
    htmlCode += "<br><button class='confirmButton' onclick='addItem()'>Adicionar Item</button><button class='deleteButton' onclick='excluirElementoTela()' >Excluir um item</button>"
   htmlCode += "<br><button class='normalButton' onclick='telaFinal()'>Finalizar</button>"
...
function addButtonsContent() {
  ...
  htmlCode += "<br><button class='normalButton' onclick='telaInicial()'>Adicionar Mais Itens</button><button class='normalButton' onclick='novaLista()' >Criar nova lista</button>"
